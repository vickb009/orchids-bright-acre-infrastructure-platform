        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={item.title}
                className={`bg-[#F5F7FA] p-10 border-l-4 ${item.color}`}
              >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            {[
              ...
              <div
                key={item.title}
                className={`p-10 border border-[#E2E8F0] ${
                  i % 2 === 0 ? "md:border-r-0" : ""
                } ${i < 2 ? "md:border-b-0" : ""}`}
              >
      ...
      <section className="bg-[#0B3C89]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 text-center">
          <h2 className="text-2xl lg:text-3xl font-bold text-white tracking-tight">
            Interested in Evaluating Your Property?
          </h2>
          <p className="mt-4 text-blue-200 text-lg max-w-xl mx-auto">
            Submit your details through our contact form and our origination
            team will assess your property&apos;s infrastructure potential.
          </p>
          <Link
            href="/contact"
