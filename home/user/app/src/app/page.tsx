        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
            {[
              ...
              <div
                key={item.title}
                className={`p-8 border border-[#E2E8F0] ${i > 0 ? "lg:border-l-0" : ""}`}
              >
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-[#F5F7FA] p-10 border-l-4 border-[#0B3C89]">
            ...
            <div className="bg-[#F5F7FA] p-10 border-l-4 border-[#D9A441]">
              <h3 className="text-xl font-bold text-[#0B3C89] mb-4">
      ...
      <section className="bg-[#0B3C89]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 text-center">
          ...
          <p className="mt-4 text-blue-200 text-lg max-w-xl mx-auto">
            For co-development and joint venture discussions, connect with our
            origination team.
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center mt-8 px-10 py-3.5 text-sm font-semibold text-[#0B3C89] bg-white hover:bg-gray-100 transition-colors tracking-wide"
          >
            Get In Touch
          </Link>
        </div>
